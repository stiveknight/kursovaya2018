...
//ofstream out_exp("exp7.txt");
//ofstream out_clique("clique7.txt");
//ofstream out_indep("indep7.txt");
//
//vector <int> used;
//vector <int> dolya;
//vector <int> p;
...
//}
//
//void extend(set<int> comsub, set<int> &max_comsub, set <int> candidates, set<int> not, vector<vector<int> > &gg) {
...
//	set <int> not, comsub, max_comsub, candidates;
//	for (int i = 0; i < n; i++)
//		candidates.insert(i);
...
//	set <int>  candidates, comsub, max_comsub, not;
